...
void handle_srli(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm5 = sext(MASK24_20(cur_inst), 5);
    NEXT_LATCHES.REGS[rd] = (int) ((unsigned int)CURRENT_LATCHES.REGS[rs1] >> imm5);
...
void handle_srl(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst),
        rs1 = MASK19_15(cur_inst),
        rs2 = MASK24_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = (int) ((unsigned int)CURRENT_LATCHES.REGS[rs1] >> CURRENT_LATCHES.REGS[rs2]);
...
void handle_lh(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext((MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]]) & 0xFFFF, 16);
...
void handle_sb(unsigned int cur_inst) {
    ...
    int imm12 = (MASK31_25(cur_inst) << 5) + (MASK11_7(cur_inst) << 11) ;
...
void handle_sh(unsigned int cur_inst) {
    ...
    unsigned int rs2 = MASK24_20(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = (MASK31_25(cur_inst) << 5) + (MASK11_7(cur_inst) << 11) ;
    MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]] = sext((CURRENT_LATCHES.REGS[rs2])& 0xFFFF, 16);
